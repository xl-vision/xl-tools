...
gulp.task('compile:dist:ts', () => bundle({
  input: 'src/index.tsx',
  output: 'dist',
  name: 'xl-vision',
  babelConfig: getBabelConfig({ typescript: true, modules: false })
}))

gulp.task('compile:dist', gulp.parallel('compile:dist:ts', 'compile:dist:style'))
